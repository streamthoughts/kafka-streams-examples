...
public class TopicNameExtractorProcessorTopology implements TopologyProvider {
    ...
    public Topology get() {
        ...
        final TopicNameExtractor<Object, String> topicNameExtractor =
                (key, value, recordContext) -> "topic-words-" + value.charAt(0);

        topology.addSink("sink-processor", topicNameExtractor, "processor-filter-stop-words");
